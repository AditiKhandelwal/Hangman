...
def moderate():
    ...
    label3=tkinter.Label(text="MODERATE LEVEL",fg="black",bg="mediumaquamarine",font=("Helvetica", 40,"bold italic"))
    label3.pack()
...
def search3():
    ...
    for i in range(0,5):
        if str[i] == ch and str[i] !='E'  and ar[i]==0 :
            hefty=hefty+1
            ar[i]=1
            attempt3 = attempt3+1
            update3(i)
...
def search2():
    ...
    for i in range(0,5):
        if str[i] == ch and str[i] !='E' and str[i]!='A' and a[i]==0:
            adept=adept+1
            a[i]=1
            attempt2 = attempt2+1
            update2(i)
...
def check5():
        ...
        str="FAMILY"
        for i in range(0,6):
            if str[i] == ch  and str[i] !='A' and str[i] != 'I' and m5[i]==0:
                family=family+1
                att5=att5+1
                m5[i]=1
                change5(i)
...
def check3():
    ...
    str="EFFORT"
    for i in range(0,6):
        if str[i] == ch and str[i] !='E' and str[i] !='O' and m3[i]==0:
            effort=effort+1
            m3[i]=1
            att3=att3+1
            change3(i)
...
def check2():
    ...
    str="CAREER"
    for i in range(0,6):
        if str[i] == ch and str[i] !='A' and str[i] !='E' and m2[i]==0:
            career=career+1
            m2[i]=1
            att2=att2+1
            change2(i)
...
def check():
    ...
    str="BATTLE"
    for i in range(0,6):
        if str[i] == ch and str[i] != 'A' and str[i] != 'E' and m1[i]==0:
            battle=battle+1
            att1=att1+1
            m1[i]=1
            change(i)
...
path1="C:\\Users\Aditi khandelwal\Desktop\hangman\hang\images\mainpage.jpg"
...
path2="C:\\Users\Aditi khandelwal\Desktop\hangman\hang\images\instruct.jpg"
inst = ImageTk.PhotoImage(Image.open(path2))
panel2 = Label(my,image=inst)

# image for mode page

path3="C:\\Users\Aditi khandelwal\Desktop\hangman\hang\images\modes.jpg"
mode = ImageTk.PhotoImage(Image.open(path3))
panel3 = Label(my,image=mode)

# image for easy page

path4="C:\\Users\Aditi khandelwal\Desktop\hangman\hang\images\easy.jpg"
soft = ImageTk.PhotoImage(Image.open(path4))
panel4 = Label(my,image=soft)

# image for easy page

path5="C:\\Users\Aditi khandelwal\Desktop\hangman\hang\images\hard.jpg"
hard = ImageTk.PhotoImage(Image.open(path5))
panel5 = Label(my,image=hard)

# image for QUIT page

path6="C:\\Users\Aditi khandelwal\Desktop\hangman\hang\images\quit.jpg"
...
q2c=Label(text="E",fg="black",bg="LightBlue1",height=1,width=2,font=("Helvetica", 50,"underline"))
...
q2cn=Label(text="E",fg="black",height=1,width=2,bg="LightBlue1",font=("Helvetica", 50,"underline"))
...
q3b=Label(text="E",fg="black",bg="LightBlue1",height=1,width=2,font=("Helvetica", 50,"underline"))
q3c=Label(text="_",fg="black",bg="LightBlue1",height=1,width=2,font=("Helvetica", 50))
q3d=Label(text="_",fg="black",bg="LightBlue1",height=1,width=2,font=("Helvetica", 50,"underline"))
q3e=Label(text="_",fg="black",bg="LightBlue1",height=1,width=2,font=("Helvetica", 50))

# labels with text of ques 3

q3an=Label(text="H",fg="black",height=1,width=2,bg="LightBlue1",font=("Helvetica", 50,"underline"))
q3bn=Label(text="E",fg="black",height=1,width=2,bg="LightBlue1",font=("Helvetica", 50,"underline"))
q3cn=Label(text="F",fg="black",height=1,width=2,bg="LightBlue1",font=("Helvetica", 50,"underline"))
q3dn=Label(text="T",fg="black",height=1,width=2,bg="LightBlue1",font=("Helvetica", 50,"underline"))
q3en=Label(text="Y",fg="black",height=1,width=2,bg="LightBlue1",font=("Helvetica", 50,"underline"))
...
m1b=Label(text="A",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
...
m1f=Label(text="E",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))

# labels with text of ques 1

m1an=Label(text="B",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m1bn=Label(text="A",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m1cn=Label(text="T",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m1dn=Label(text="T",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m1en=Label(text="L",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m1fn=Label(text="E",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))

#labels for easy level ques 2

m2a=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m2b=Label(text="A",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m2c=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m2d=Label(text="E",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m2e=Label(text="E",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m2f=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))

# labels with text of ques 2

m2an=Label(text="C",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m2bn=Label(text="A",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m2cn=Label(text="R",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m2dn=Label(text="E",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m2en=Label(text="E",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m2fn=Label(text="R",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))

# label for easy level ques 3

m3a=Label(text="E",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m3b=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m3c=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m3d=Label(text="O",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
...
m3an=Label(text="E",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m3bn=Label(text="F",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m3cn=Label(text="F",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m3dn=Label(text="O",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m3en=Label(text="R",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
...
m5b=Label(text="A",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m5c=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m5d=Label(text="I",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m5e=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))
m5f=Label(text="_",fg="black",bg="aquamarine",height=1,width=2,font=("Helvetica", 50))

# labels with text of ques 5

m5an=Label(text="F",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m5bn=Label(text="A",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m5cn=Label(text="M",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m5dn=Label(text="I",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m5en=Label(text="L",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
m5fn=Label(text="Y",fg="black",height=1,width=2,bg="aquamarine",font=("Helvetica", 50))
